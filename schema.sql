...
(3, 'Ricardo Andrés', 'Rojas Rico', 1, '1111122448', '3173926578', 'rrojas48@itfip.edu.co', '$2y$10$8IHHUiZZeSXWca4o7L30POwNkOeKBrN5oiJ7J75sngtvUW6TDcx9K', 'admin', 'admin,add,schedule,reports,statistics');
...
ALTER TABLE `people`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Campo que guarda el id de las personas agendadas (autoincremental).', AUTO_INCREMENT=8;
COMMIT;
